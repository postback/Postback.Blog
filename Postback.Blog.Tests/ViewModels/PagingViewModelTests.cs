...
namespace Postback.Blog.Tests.ViewModels
{
    ...
    public class PagingViewModelTests
    {
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 1, ItemCount = 9, ItemsOnOnePage = 10 };
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 1, ItemCount = 10, ItemsOnOnePage = 10 };
            Assert.That(paging.GetItems(), Has.Count.EqualTo(0));
        }
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 1, ItemCount = 11, ItemsOnOnePage = 10 };
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 1, ItemCount = 500, ItemsOnOnePage = 10 };
            Assert.That(paging.GetItems().First().Label, Is.EqualTo("1"));
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 1, ItemCount = 90, ItemsOnOnePage = 10 };
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 5, ItemCount = 90, ItemsOnOnePage = 10 };
            Assert.That(paging.GetItems(), Has.Count.EqualTo(9));
            Assert.That(paging.GetItems().First().Label, Is.EqualTo("1"));
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 1, ItemCount = 5000, ItemsOnOnePage = 10 };
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 5, ItemCount = 5000, ItemsOnOnePage = 10 };
            Assert.That(paging.GetItems(), Has.Count.EqualTo(11));
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 7, ItemCount = 5000, ItemsOnOnePage = 10 };
            Assert.That(paging.GetItems(), Has.Count.EqualTo(11));
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 10, ItemCount = 210, ItemsOnOnePage = 10 };
            Assert.That(paging.GetItems(), Has.Count.EqualTo(11));
        ...
        {
            var paging = new PagingView("home","index") { CurrentPage = 495, ItemCount = 5000, ItemsOnOnePage = 10 };
            Assert.That(paging.GetItems(), Has.Count.EqualTo(11));
